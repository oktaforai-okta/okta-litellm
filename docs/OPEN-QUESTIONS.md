...
| P0 | What exact claim identifies the agent in the final Custom-AS token? | Sanitized token profile + resource validation test | Okta/O4AA + resource owners | Gate 2 |
